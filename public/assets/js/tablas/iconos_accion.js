...
(function () {
    // Si la librería ya fue inicializada, evitamos volver a ejecutar todo
    if (window.IconosAccion && window.IconosAccion.crear) {
        return;
    }
    ...
    // Ejecutamos la inyección de estilos
    inyectarEstilosIconos();
