...
require_once BASE_PATH . '/app/models/VentaDocumentoModel.php';
require_once BASE_PATH . '/app/models/VentaDespachoModel.php';
require_once BASE_PATH . '/app/controllers/PermisosController.php';

class VentaController extends Controlador
{
    private VentaDocumentoModel $documentoModel;
    private VentaDespachoModel $despachoModel;

    public function __construct()
    {
        $this->documentoModel = new VentaDocumentoModel();
