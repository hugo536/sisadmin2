...
require_once BASE_PATH . '/app/models/CompraOrdenModel.php';
require_once BASE_PATH . '/app/models/CompraRecepcionModel.php';
require_once BASE_PATH . '/app/controllers/PermisosController.php';

class CompraController extends Controlador
{
    private CompraOrdenModel $ordenModel;
    private CompraRecepcionModel $recepcionModel;

    public function __construct()
    {
        $this->ordenModel = new CompraOrdenModel();
        $this->recepcionModel = new CompraRecepcionModel();
    }
