...
<div class="container-fluid p-4">
    <div class="d-flex justify-content-between align-items-center mb-4 fade-in">
        ...
        <button class="btn btn-primary shadow-sm" type="button" data-bs-toggle="collapse" data-bs-target="#crearUsuarioCollapse" aria-expanded="false" aria-controls="crearUsuarioCollapse">
    ...
    <div class="collapse mb-4" id="crearUsuarioCollapse">
        <div class="card border-0 shadow-sm overflow-hidden">
            <div class="card-header bg-white py-3">
                <h6 class="mb-0 fw-bold text-primary"><i class="bi bi-plus-circle me-2"></i>Registrar nuevo usuario</h6>
            </div>
            <div class="card-body p-4 bg-light">
                <form method="post" class="row g-3" id="formCrearUsuario">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="newUser" name="usuario" placeholder="Usuario" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <select class="form-select" id="newRol" name="id_rol" required>
                                <option value="" selected>Seleccionar...</option>
                                <?php foreach ($roles as $rol): ?>
                                    <option value="<?php echo (int) $rol['id']; ?>"><?php echo e((string) $rol['nombre']); ?></option>
                                <?php endforeach; ?>
                            </select>
                            <label for="newRol">Rol Asignado</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="password" class="form-control" id="newClave" name="clave" placeholder="Contraseña" required>
                            <label for="newClave">Contraseña</label>
                        </div>
                    </div>
                    <div class="col-md-4 d-flex align-items-center">
                        <button class="btn btn-primary w-100 h-100 py-3 fw-bold" type="submit">
                            Guardar Usuario
                        </button>
                    </div>
                </form>
