    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" class="row g-2">
                ...
                <div class="col-md-3"><input class="form-control" name="clave" type="password" placeholder="Clave" required></div>
                <div class="col-md-3">
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive">
            <table class="table align-middle">
                <thead><tr><th>ID</th><th>Usuario</th><th>Rol</th><th>Estado</th><th>Último login</th><th>Acciones</th></tr></thead>
                <tbody>
                <?php foreach ($usuarios as $u): ?>
                    <tr>
                        ...
                        <td class="d-flex gap-1">
                            <button class="btn btn-sm btn-outline-primary" onclick="editarUsuario(<?php echo (int) $u['id']; ?>,'<?php echo e((string) $u['usuario']); ?>',<?php echo (int) $u['id_rol']; ?>)">Editar</button>
...
<script>
function editarUsuario(id, usuario, idRol){document.getElementById('editId').value=id;document.getElementById('editUsuario').value=usuario;document.getElementById('editRol').value=idRol;new bootstrap.Modal(document.getElementById('modalEditarUsuario')).show();}
