                        ...
                        <?php else: ?>
                            <?php foreach ($incidencias as $row): ?>
                                <?php
                                    ...
                                    if ($tipo === 'VACACIONES') $badgeTipo = 'bg-info text-dark';
                                    if ($tipo === 'DESCANSO_MEDICO') $badgeTipo = 'bg-danger';
                                    if ($tipo === 'PERMISO_PERSONAL') $badgeTipo = 'bg-warning text-dark';
                                    if ($tipo === 'SUBSIDIO') $badgeTipo = 'bg-primary';
                                ...
                                <tr class="border-bottom">
                                    ...
                                    <td class="align-top pt-3 fw-medium text-secondary" style="font-size: 0.85rem;">
