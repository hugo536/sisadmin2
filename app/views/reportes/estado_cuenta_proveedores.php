...
<div class="container-fluid p-4" id="reportesEstadoCuentaProveedoresApp" data-url-index="<?php echo e(base_url() . '/'); ?>">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 fade-in">
        <div>
            ...
            <p class="text-muted small mb-0 ms-1">Historial cronológico de cargos y abonos por proveedor.</p>
        </div>
        ...
        <div class="card-body p-3">
            <form class="row g-2 align-items-end" method="get" action="<?php echo e(base_url() . '/'); ?>" id="estadoCuentaProveedoresFiltrosForm">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <select name="proveedor" id="filtroProveedorEstadoCuenta" class="form-select bg-light">
                ...
                <div class="col-12 col-md-2">
                    <button type="button" class="btn btn-danger w-100 shadow-sm fw-semibold" id="btnExportarPdfProveedores">
    ...
    <?php else: ?>
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
                ...
                <div class="input-group input-group-sm w-auto" style="max-width: 260px;">
                    <span class="input-group-text bg-light border-end-0"><i class="bi bi-search text-muted"></i></span>
                    <input type="search" class="form-control bg-light border-start-0 ps-0" id="filtroEstadoCuentaProveedoresDetalle" placeholder="Filtrar en tabla...">
                </div>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table align-middle mb-0 table-pro" id="tablaEstadoCuentaProveedoresDetalle"
                        ...
                        <?php else: ?>
                            <?php foreach ($rows as $row): ?>
                                ...
                                $search = mb_strtolower(trim(($row['proveedor'] ?? '') . ' ' . ($row['documento'] ?? '') . ' ' . ($row['producto'] ?? '')));
                                ?>
