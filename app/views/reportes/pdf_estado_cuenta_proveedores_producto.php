...
$proveedorNombre = !empty($f['proveedor']) ? $f['proveedor'] : 'TODOS LOS PROVEEDORES';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <title>Resumen de Productos - <?php echo htmlspecialchars($proveedorNombre); ?></title>
    <style>
        @page { margin: 1.5cm; }
        ...
        .detalle-tabla th { background-color: #1A1A1A !important; color: #FFFFFF !important; font-weight: bold; text-align: center; font-size: 10px; }
...
<body>
    ...
    <table class="info-cliente">
        <tr>
            ...
            <td><strong><?php echo htmlspecialchars($proveedorNombre); ?></strong></td>
        </tr>
    </table>
    ...
    <table class="detalle-tabla">
        <thead>
            <tr>
                ...
                <th style="width: 20%;">CANTIDAD COMPRADA</th>
