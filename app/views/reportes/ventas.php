        ...
        <div class="card-body p-4 bg-white">
            <form class="row g-3" method="get" action="<?php echo e(route_url('reportes/ventas')); ?>" id="formFiltrosReporteVentas">
                ...
                <div class="col-12 col-md-5 col-lg-2">
                    ...
                    <select name="estado" class="form-select bg-light shadow-sm auto-submit">
                ...
                <div class="col-12 col-lg-5 d-flex flex-column justify-content-end">
                    <?php if ($seccionActiva === 'tendencias'): ?>
                        <div class="d-flex gap-2">
                            <div class="w-50">
                                ...
                                <select name="agrupacion" class="form-select bg-light border-info-subtle shadow-sm auto-submit">
                            ...
                            <div class="w-50">
                                ...
                                <select name="tipo_grafico" class="form-select bg-light border-info-subtle shadow-sm auto-submit">
                    ...
                    <?php if ($seccionActiva === 'clientes' || $seccionActiva === 'pendientes'): ?>
                        <div class="d-flex gap-2">
                            <div class="w-40">
                                ...
                                <select name="tipo_tercero" id="filtroVentasTipoTercero" class="form-select bg-light shadow-sm auto-submit">
                                    <option value="">Todos...</option>
                            ...
                            <div class="w-60">
                                ...
                                <select name="id_cliente" id="filtroVentasCliente" class="form-select bg-light shadow-sm auto-submit" placeholder="Buscar...">
                    ...
                    <?php if ($seccionActiva === 'productos'): ?>
                        <div>
                            ...
                            <select name="id_item" id="filtroVentasProducto" class="form-select bg-light shadow-sm auto-submit" placeholder="Buscar...">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white border-bottom px-4 py-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <div class="d-flex flex-wrap align-items-center gap-2">
                <!-- ACCIONES MASIVAS -->
                <button type="button" class="btn btn-sm btn-outline-danger fw-semibold d-none slide-in" id="btnGenerarPickingList">
                    <i class="bi bi-file-earmark-pdf me-1"></i>Picking List (<span id="countPicking">0</span>)
                </button>
                <button type="button" class="btn btn-sm btn-primary fw-semibold d-none slide-in" id="btnAsignarRutaMasiva" data-bs-toggle="modal" data-bs-target="#modalAsignarRuta">
                    ...
                    <thead>
                        <tr>
                            <th class="ps-4 text-center" style="width: 40px;">
                                <input class="form-check-input shadow-none border-secondary-subtle" type="checkbox" id="chkAllPendientes" title="Seleccionar todo">
                            </th>
                                ...
                                <tr class="border-bottom" data-search="<?php echo e(mb_strtolower((string)$r['documento'] . ' ' . (string)$r['cliente'] . ($esDonacion ? ' donacion' : ''))); ?>">
                                    ...
                                    <td>
                                        <?php if(!empty($r['ruta_asignada'])): ?>
                                            <span class="badge bg-light text-dark border"><i class="bi bi-truck me-1 text-primary"></i><?php echo e((string)$r['ruta_asignada']); ?></span>
                                        <?php else: ?>
