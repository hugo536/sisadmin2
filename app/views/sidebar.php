    ...
    <div class="offcanvas-header" style="background-color: var(--app-sidebar-bg, #1e293b); color: white;">
        <h5 class="offcanvas-title" id="appSidebarOffcanvasLabel">
            <?= htmlspecialchars($empresaNombre) ?>
        </h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Cerrar"></button>
    </div>
    <div class="offcanvas-body p-0 d-flex flex-column" style="background-color: var(--app-sidebar-bg, #1e293b);">
            <?php
            renderSidebarInner(
